			...
			<div class="min-height-200px">
				...
				<div class="row clearfix progress-box">
					<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
						<a style='display: block; width: 100%' href='/admin-panel/orders/copy/1kill' class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="project-info clearfix">
								...
								<div class="project-info-right">
									...
									<p class="weight-400 font-18"> Copy 1-Kill orders </p>
								</div>
							</div> 
						</a>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
						<a style='display: block; width: 100%' href='/admin-panel/orders/copy/3kill' class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="project-info clearfix">
								<div class="project-info-left">
									<div class="icon box-shadow bg-blue text-white">
										<i class="fa fa-briefcase"></i>
								...
								<div class="project-info-right">
									...
									<p class="weight-400 font-18"> Copy 3-Kill orders </p>
								</div>
							</div> 
						</a>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
						<a style='display: block; width: 100%' href='/admin-panel/orders/copy/5kill' class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="project-info clearfix">
								<div class="project-info-left">
									<div class="icon box-shadow bg-blue text-white">
										<i class="fa fa-briefcase"></i>
								...
								<div class="project-info-right">
									...
									<p class="weight-400 font-18"> Copy 5-Kill orders </p>
								</div>
							</div> 
						</a>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
						<a style='display: block; width: 100%' href='/admin-panel/orders/copy/10kill' class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
							<div class="project-info clearfix">
								<div class="project-info-left">
									<div class="icon box-shadow bg-blue text-white">
										<i class="fa fa-briefcase"></i>
								...
								<div class="project-info-right">
									...
									<p class="weight-400 font-18"> Copy 10-Kill orders </p>
								</div>
							</div> 
						</a>
					</div>
