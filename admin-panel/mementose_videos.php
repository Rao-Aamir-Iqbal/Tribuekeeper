...
<body>
    ...
    <tbody>
       <?php
            ...
            $sql = "SELECT * FROM `mementose_videos`";
       $result = mysqli_query($connect , $sql);
            $i = 1;
                           while ($row = mysqli_fetch_assoc($result)) {
                             ...
                             <td><a href="/uploads/<?php echo $videoPath?>" target="_blank"><span class="fa fa-reorder"></span></a></td>
                             <td><?php echo $publishDate ?></td>
                              ...
                              <td><div class='dropdown'><a class='btn btn-outline-primary dropdown-toggle' role='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h'></i> </a><div class='dropdown-menu dropdown-menu-right'>
                                                                                    ...
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href='includes/delete_videos.php?delete=<?php echo $row['ID'] ?> '><i class='fa fa-trash'></i> Delete</a></button>
