				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="/admin-panel" style="color:#003B59;"> Home </a></li>
       ...
       $result = mysqli_query($connect , $sql);
            $i = 1;
                           ...
                           while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td><img src="/assets/events_picture/<?php echo $row['image'] ?>" width="20%" height="20%"></td>
                              <td><div class='dropdown'><a class='btn btn-outline-primary dropdown-toggle' role='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h'></i> </a><div class='dropdown-menu dropdown-menu-right'>
                                                                                    ...
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href="includes/delete_events.php?delete=<?php echo $row['id'] ?> "><i class='fa fa-trash'></i> Delete</a></button>
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href="<?php echo $row['event_link'] ?> " target="_blank"><i class='fa fa-trash'></i> View</a></button>
