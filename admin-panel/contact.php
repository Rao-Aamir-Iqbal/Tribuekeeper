            ...
            $i = 1;
                           ...
                           while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td><?php echo $row['message'] ?></td>
                              ...
                              <button class='dropdown-item' style='cursor: pointer' type='submit'><a href="includes/delete_contact.php?delete=<?php echo $row['id'] ?> "><i class='fa fa-trash'></i> Delete</a></button>
