...
<body>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4> Keepers + Profile </h4>
							</div>
							<nav role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="/admin-panel"> Home </a></li>
									<li class="breadcrumb-item active"> keeper </li>
									<li class="breadcrumb-item active"> keepers + Profile</li>
								</ol>
							</nav>
						</div>
					</div>
    ...
    <tbody>
       <?php
       $sql = "SELECT * FROM `users` WHERE membership = '1'";
                           ...
                           while ($row = mysqli_fetch_assoc($result)) {
                             ...
                             ?></td>
                              <td><div class='dropdown'><a class='btn btn-outline-primary dropdown-toggle' role='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h'></i> </a><div class='dropdown-menu dropdown-menu-right'>
                                                                                    ...
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href='includes/delete_keepers_profile.php?delete=<?php echo $row['ID'] ?> '><i class='fa fa-trash'></i> Delete</a></button>
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href='includes/cancle_membership.php?cancle=<?php echo $row['ID'] ?> '><i class='fa fa-trash'></i> Cancel Membership</a></button>
