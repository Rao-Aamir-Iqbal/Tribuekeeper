       ...
       $result = mysqli_query($connect , $sql);
            $i = 1;
                           ...
                           while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $publishDate = date("d M Y h:m:s A", strtotime($row['date']))
                            ...
                            <td><?php echo  $data['firstname'] . " " .  $data['lastname'] ?></td>
                             ...
                             <td><?php echo $publishDate  ?></td>
                              ...
                              <td><div class='dropdown'><a class='btn btn-outline-primary dropdown-toggle' role='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h'></i> </a><div class='dropdown-menu dropdown-menu-right'>
                                                                                    ...
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href="includes/transaction_delete.php?delete=<?php echo $row['id'] ?> "><i class='fa fa-trash'></i> Delete</a></button>
