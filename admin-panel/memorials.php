						...
						<div class="col-md-6 col-sm-12">
							...
							<nav role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active"> Memorial Profile</li>
								</ol>
							</nav>
						</div>
					</div>
       ...
       $result = mysqli_query($connect , $sql);
            $i = 1;
                           while ($row = mysqli_fetch_assoc($result)) {
                             ...
                             print("----");
                             }else{ echo $row['date_of_death']; }?></td>
                             <td><?php echo $row['gender'] ?></td>
                             
                             <td><?php  
                             if($row['status'] === '0'){
                              print("<span class='badge badge-secondary'> Pending </span>");
                             }else if( $row['status'] === '1'){
                               print("<span class='badge badge-success'> Delivered </span>");
                             ...
                             ?></td>
                              ...
                              <td><div class='dropdown'><a class='btn btn-outline-primary dropdown-toggle' role='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h'></i> </a><div class='dropdown-menu dropdown-menu-right'>
                                                                                    ...
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href='includes/delete_memorial.php?delete=<?php echo $row['ID'] ?> '><i class='fa fa-trash'></i> Delete</a></button>
