       ...
       $result = mysqli_query($connect , $sql);
            $i = 1;
                           ...
                           while ($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  $mysql = "SELECT * FROM `users` WHERE ID = ". $row['kepper_ids'];
                                  $check = mysqli_query($connect , $mysql);
                                  
                                    if($check){
                                    $keepers_data =mysqli_fetch_assoc($check);
                                      }
                            ...
                            <td><?php echo  $data['firstname'] . " " .  $data['lastname'] ?></td>
                             <td><?php echo $keepers_data['firstname'] .  " " . $keepers_data['lastname'] ?></td>
                              ...
                              <td><div class='dropdown'><a class='btn btn-outline-primary dropdown-toggle' role='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h'></i> </a><div class='dropdown-menu dropdown-menu-right'>
                                                                                    ...
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href="includes/delete_keeper.php?delete=<?php echo $row['id'] ?> "><i class='fa fa-trash'></i> Delete</a></button>
