...
<body>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active"> Mementose</li>
									<li class="breadcrumb-item active">Mementose Pictures </li>
								</ol>
							</nav>
						</div>
					</div>
    ...
    <tbody>
       <?php
            ...
            $sql = "SELECT * FROM `mementose_pictures`";
       $result = mysqli_query($connect , $sql);
            $i = 1;
                           while ($row = mysqli_fetch_assoc($result)) {
                             ...
                             <td><img src="/uploads/<?php echo $row['image_path'] ?>" width="20%" height="20%"></td>
                             <td><?php echo $publishDate ?></td>
                              ...
                              <td><div class='dropdown'><a class='btn btn-outline-primary dropdown-toggle' role='button' data-toggle='dropdown'><i class='fa fa-ellipsis-h'></i> </a><div class='dropdown-menu dropdown-menu-right'>
                                                                                    ...
                                                                                    <button class='dropdown-item' style='cursor: pointer' type='submit'><a href='includes/delete_mementose.php?delete=<?php echo $row['ID'] ?> '><i class='fa fa-trash'></i> Delete</a></button>
                                                                                   
                                                                                     <button class='dropdown-item' style='cursor: pointer' type='submit'><a href='comments?view=<?php echo $row['ID'] ?> '> <i class="fa fa-trash"></i> View Comments</a></button>
