            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="my-5 col-md-6">
                    <div class="card card-registration my-4 card-background">
                        <form id="otp-form" method="POST" action="/php/otp_personal.php">
                            <div class="row g-0">
                                <div class="col-xl-12" style="font-size: small !important">
                                    <div class="card-body p-md-5 text-black">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                <div class="form-outline mb-4">
                                                    <label for="" class="mb-2 fw-bold ms-1">We have emailed you a one time passcode please type it in the box below</label>
                                                    <input type="text" id="otp" name="otp" placeholder="Enter OTP Code" class="form-control form-control-lg sign-up-second-input-box" />
                                        ...
                                        <div class="d-flex justify-content-end pt-3">
                                            ...
                                            <button type="submit" name="otpsubmit" class="submit-button btn btn-lg ms-2">Login</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $('#otp-form').validate({
                ...
                messages: {
                    otp: {
                        ...
                        minlength: "The OTP code must be 6 digits long",
                        maxlength: "The OTP code must be 6 digits long",
                        digits: "The OTP code must contain only digits"
                    }
                },
